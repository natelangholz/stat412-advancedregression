...
genres <- read.csv("http://www.stat.columbia.edu/~gelman/arm/examples/risky.behavior/risky_behaviors.dta")
```
...
### 3
**Data Splitting**: Create a variable importance plot from you best model. What features are most important?
